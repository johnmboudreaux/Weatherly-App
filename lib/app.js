...
export default class App extends Component {
  ...
  getData(location) {
    ...
    .then((responseData) => {
      this.setState({ today: responseData.forecast.simpleforecast.forecastday[0],
                      tenDay: responseData.forecast.simpleforecast.forecastday,
                      currentCity: responseData.current_observation,
                      hourlyCards: responseData.hourly_forecast.splice(0, 7),
                      status: true
                    });
    })
    .catch(() => alert('Please enter a valid  City, State or Zip Code'));
  }
