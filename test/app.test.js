...
describe('App', () => {
  ...
  it('should change state for ten day ', () => {
      ...
      app.setState({
        tenDay: [{ date: '11/23/1985' }] });

      expect(app.state('tenDay')).toEqual([{ date: '11/23/1985' }]);
    });
 ...
 it('should change state current city', () => {
    ...
    it('should change state hourly cards', () => {
        ...
        app.setState({
          hourlyCards: [{ date: '11/23/1985' }] });

        expect(app.state('hourlyCards')).toEqual([{ date: '11/23/1985' }]);
      });
